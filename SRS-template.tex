...
The goal of this document is to define a clear project scope that will be used to contain and guide coming deliverables as well as give clarity as to how our application will function as a system built up out of well-defined components.
   ...
   \section{Overall Description}
   	...
   	\subsection{Hardware Interfaces}
   		%Matthew
   		The Split Bill system will make use of the smart phone's camera in order to take a picture of the bill for processing. The WiFi module, or the mobile network module will be used to establish a connection over the internet to the central server. Bluetooth module will be used to establish an offline connection to other devices using the app, to split the bill with them.
...
\end{itemize}
   \section{Specific Requirements}
	\subsection{External Interface Requirements}
		%Matthew
		The system will make use of the camera on the smart phone to capture a picture of the bill. This will be the extent of the hardware that the app makes use of, excluding the screen for display and interaction purposes.\\
